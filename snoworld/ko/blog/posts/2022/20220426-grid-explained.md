...
최근에 디즈니 플러스의 <q>그리드</q>를 다 보셨나요? 혼란스러운? 걱정마! 이 기사에서 나는 답을 아는 한 많은 질문에 답하고 그 이유를 설명했습니다.
...
- 연구소 1의 문이 열렸다. 고스트는 놀랐다.
- 세하가 서서 권 박사의 신분증을 건넸다.
- 고스트는 아직 새하를 모른다.
- 고스트는 새하의 고발과 극적인 연설 때문에 그리드 설치를 중단했다.
- 고스트는 매우 약해지기 시작했습니다.
- 이장혁(관리인, 김만녹의 계부)이 국정원 건물을 나서는 순간 유령은 존재에서 지워졌다.
- 그리드를 정해진 시간 안에 끝내는 것이 중요합니다(이것이 Ghost가 전 세계의 다양한 연구소에 있었던 이유입니다). 이것이 실패했기 때문에 그리드 프로그램은 완전히 실패했습니다.
...
1. 전 부부인 정세벽과 송어진이 서로를 위로하며 동침했다. 그로부터 9개월 후(2022년 7월), 별리는 귀신의 어머니로 태어났다.
...
{{< accordion summary="하얀 방에서 유령의 몸을 지키고 있던 두 사람은 누구였습니까?" status="open" class="faq" >}}
부하로 보이는 남자는 같은 배우가 연기했기 때문에 친근한 푸른 시간 여행자이거나 적의 푸른 시간 여행자일 수 있다. 세 가지 역할을 맡은 배우는 완전히 다른 캐릭터일 수도 있습니다.
