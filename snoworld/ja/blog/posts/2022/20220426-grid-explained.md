...
最近、ディズニープラスの<q>グリッド（<bdi lang="ko">그리드</bdi>）</q>を見終わった？ 混乱している？ 心配しないでください！ この記事では、私が答えを知っている限り多くの質問に答え、その背後にある理由を説明しました。
...
1. **期間の交換。** タイムトラベラーが期間に入ると、それは即座に彼らのタイムインカージョンのバージョンに置き換えられます。 以前のバージョンはもう存在しません。
    ...
    {{< accordion summary="1997-05-18最初のバージョン" >}}

- これは、グリッドが存在せず、タイムトラベルがまだ開発されていないオリジナルバージョンです。
    {{< /accordion >}}

    {{< accordion summary="1997-05-18第2バージョン" >}}
...
- これらの一連の出来事は、ゴーストの誕生につながりました。
    ...
    {{< accordion summary="1997-05-18第3バージョン（エピソード3 IRR CCTV）" >}}
- これは、Ghostがグリッドをインストールしたバージョンです。
- これは、この日の最初のCCTV映像に表示されるバージョンでもあります。
- クォン博士は彼の身分証明書（首の後ろの傷跡）で殺されました。
- イ・チャンヒョクは、ラジオ研究所（IRR）を去る前に、幽霊に殺されました。
    {{< /accordion >}}

    {{< accordion summary="1997-05-18第4バージョン" >}}
- SaeHaが1997年に旅行したのはこれが初めてです。
- クォン・ス・クン博士は彼の身分証明書で殺された（首の後ろを装置で叩いた）。
- イ・チャンヒョクは彼の体を見て、ラボ1に入って119に電話し、ゴーストを見て、彼女と対峙し、彼の死に至りました。
- ゴーストが自分のタイムデバイスを手に取ったとき、彼女は別のタイムトラベラーの存在を感じました。 彼女が行動することができる前に、SaeHaは時間をリセットしました。
    {{< /accordion >}}

    {{< accordion summary="1997-05-18第5バージョン" >}}
- これは、1997年の出来事を変えるためのSaeHaの最初の試みです。
- セハはクォン博士のIDを盗んだ。
- 幽霊が現れたが、クォン博士は彼女が期待していた場所ではなかった。
- ラボ1のドアが開きました。 幽霊はびっくりしました。
- セハは立っていて、クォン博士の身分証明書を手渡した。
- 幽霊はまだセハを知りません。
- ゴーストは、セハの告発と劇的なスピーチのためにグリッドのインストールを停止しました。
- 幽霊は非常に弱く感じ始めました。
- イ・チャンヒョク（用務員、キム・マ・ノクの継父）がIRRビルの外に出た瞬間、幽霊は姿を消した。
- 時間枠内にグリッドを完成させることはタイムクリティカルです（これが、ゴーストが世界中のさまざまなラボにいた理由です）。 これが失敗したため、グリッドプログラムは完全に失敗しました。
- これを<q>第5バージョンの現実</q>または<q>1997年のグリッドなしの現実</q>と呼びます。
    {{< /accordion >}}

    {{< accordion summary="1997-05-18第6版" >}}
...
{{< accordion summary="セハは死んだの？" class="faq" >}}
...
{{< accordion summary="なぜ幽霊は彼女が未来に旅行することができるかどうか方法があることを知らなかったのですか？" class="faq" >}}
...
{{< accordion summary="Sae Haの死とGhostおよびGridとの関係は何ですか？" class="faq" >}}
キム・マ・ノックの手による彼の死は、これらの重要な出来事のきっかけとなります。

1. 元夫婦のチョン・セビョクとソン・エオ・ジンはお互いに慰め合い、一緒に寝ました。 9か月後（2022年7月）、幽霊の母であるビョリが生まれました。
...
<q>[Did Sae Ha die?](#did-sae-ha-die)</q>で説明したように、倉庫SaeHaがタイムトラベルデバイスを返却する前にSaeHaになることはできません。 倉庫セハは2022年にあり、2021セハが2022年に旅行することはできません。
{{< /accordion >}}
...
これは、<q>[セハの死と幽霊とグリッドとの関係は何ですか？](#what-is-the-relation-of-sae-has-death-to-the-ghost-and-the-grid)</q>、起こります。
{{< /accordion >}}
...
{{< accordion summary="白い部屋で幽霊の体を守っている二人の男は誰でしたか？" status="open" class="faq" >}}
キャラクターが同じ俳優によって演じられたので、部下であるように見える人は、フレンドリーブルータイムトラベラーまたはフォーブルータイムトラベラーである可能性があります。 俳優が3つの役割を果たしたという、まったく別のキャラクターである可能性もあります。
...
{{< accordion summary="ゴーストの時代にグリッドがなかったら、彼女はまったく存在してはいけませんか？" class="faq" >}}
...
これは、<q>[Temporal Mechanics＃4：Time period replace](＃temporal-mechanics)</q>で説明されています。
{{< /accordion >}}
...
{{< accordion summary="エピソード10の<q>レイヤー</q>とはどういう意味ですか？" class="faq" >}}
