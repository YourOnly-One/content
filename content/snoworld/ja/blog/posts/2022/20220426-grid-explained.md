...
- これらの一連の出来事は、ゴーストの誕生につながりました。
  ...
  {{% accordion border="style01" summary="1997-05-18第3バージョン（エピソード3 IRR CCTV）" %}}
...
- イ・チャンヒョクは、ラジオ研究所（IRR）を去る前に、幽霊に殺されました。
  ...
  {{% accordion border="style01" summary="1997-05-18第4バージョン" %}}
...
- ゴーストが自分のタイムデバイスを手に取ったとき、彼女は別のタイムトラベラーの存在を感じました。 彼女が行動することができる前に、SaeHaは時間をリセットしました。
  ...
  {{% accordion border="style01" summary="1997-05-18第5バージョン" %}}
...
- これを{{% quote type="work" lang="ja" %}}第5バージョンの現実{{% /quote %}}または{{% quote type="work" lang="ja" %}}1997年のグリッドなしの現実{{% /quote %}}と呼びます。
  {{% /accordion %}}

  {{% accordion border="style01" summary="1997-05-18第6版" %}}
...
- イ・チャンヒョクは彼らを見て走った。
  ...
  {{% accordion border="style01" summary="1997-05-18第7版" %}}
...
- 1997年のゴーストがセハが誰であるかを知ったのはこれが初めてです。 その後、ラボ1でコンバージョンが発生し、{{% quote type="work" lang="ja" %}}別の方法を見つけるために、これを数十回繰り返しました{{% /quote %}}と彼女は言いました。
...
{{% quote type="work" lang="ja" %}}多くの人のニーズが少数の人のニーズを上回っている{{% /quote %}}場合です。
...
{{% accordion border="style01" summary="キム・マー・ノックがゴーストの直接の祖先ではない場合、誰ですか？" class="faq" %}}
...
{{% accordion border="style01" summary="なぜ幽霊のDNAはより良く、Sae Haにさえ感謝したのですか？" class="faq" %}}
