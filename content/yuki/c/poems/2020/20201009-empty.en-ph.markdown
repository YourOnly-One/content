...
relCanonical = "https://im.youronly.one/yuki/poems/empty/"																									# only needed when this is not the original post
...
<figure class="quote_box qbs_stanza qbc_pink">
  ...
  <figcaption class="attribution_copyright txt_center">
    <p><small>
      "<b>Empty</b>" Copyright © 2020 "<a href="https://im.youronly.one/yugenbard/" rel="dct:creator noopener" referrerpolicy="strict-origin-when-cross-origin">The Yūgen Bard</a>" (<a href="https://youronly.one" rel="dct:creator noopener" referrerpolicy="strict-origin-when-cross-origin">Yahuhanan Yukiya Sese Cuneta</a>)<br/>
