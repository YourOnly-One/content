...
disquq_identifier = "ultima-video-games-release-timeline-202323"                                # set if date of this content is different from main translation
...
A release timeline of {{% quote type="name" lang="en" %}}Ultima{{% /quote %}} video games.
